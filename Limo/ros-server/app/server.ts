...
import { NodeReturnToBase } from './classes/ros/nodes/node-return-to-base';
...
export class Server {
  ...
  init(): void {
    ...
    const nodeManager = new NodeManager(nodeExplorationState, nodeReturnToBase, nodeMovement, nodeUpdate, nodeBattery);
