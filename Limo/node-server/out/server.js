...
const server_socket_1 = require("./services/server-socket");
const client_socket_1 = require("./services/client-socket");
let Server = Server_1 = class Server {
    ...
    init() {
        ...
        this.serverSocketService = new server_socket_1.ServerSocketService(this.io);
        this.serverSocketService.init();
        this.clientSocketService = new client_socket_1.ClientSocketService();
